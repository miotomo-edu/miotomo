...
### Adventure
An **Adventure** is a complete topic journey — analogous to a TV series or thematic unit. Example: *"What Were Dinosaurs, Actually?"* An Adventure contains 4–5 Episodes and is the top-level unit of curriculum organization. Completing all the Episodes in an Adventure unlocks a Teachtime session with Tomo — the culmination of the journey.

### Episode
An **Episode** is one part of an Adventure — the specific audio content the child just listened to before starting a Miotomo session. Each Episode features one or more subject-matter experts and has associated vocabulary, spelling words, and discussion topics that inform the conversation. After listening, the child speaks directly with the expert(s) from that Episode.
...
Tomo is the consistent anchor across the entire Miotomo experience. While topic-native expert characters change with each Adventure, Tomo is always present as:
...
- The **badge keeper** — Tomo receives and holds the badges the child earns across Episodes, tracking the journey
- The **culminating conversation partner** in Teachtime — the payoff of every Adventure
...
Each Adventure features its own cast of expert characters drawn directly from the topic world. Rather than recurring human hosts, the experts are characters who *belong* to the subject matter: a Roman senator and a soldier for an Adventure about Rome, a T-Rex and a Stegosaurus for an Adventure about dinosaurs, anthropomorphised shadow shapes for an Adventure about light and shadows.
...
- **No fixed recurring cast**: each Adventure's characters are unique, giving the art and narrative teams creative freedom per Adventure and avoiding emotional dependency on persistent human characters.
...
Each Adventure's character pairing is designed to naturally cover contrasting orientations — one more experiential and sensory, one more factual and analytical — mirroring the complementary lenses that effective topic exploration requires.

Expert characters appear only during Episode voice sessions. They do not appear during games or Teachtime, which belong entirely to Tomo.

---

## Adventure Progression

An Adventure follows a deliberate arc:

1. **Episode 1** — child listens to the audio → expert voice session (e.g. storytelling, debate, or mediation)
2. **Episode 2** — child listens → expert voice session
3. **Episodes 3–5** — same pattern, each building on the previous
4. **Teachtime** — after all Episodes are complete, the child has a culminating session with Tomo, teaching him everything they have learned across the Adventure

Teachtime is the payoff of the journey: Tomo finally gets to learn from the child who has become a genuine expert on the Adventure's topic.

---

## Badges

As a child progresses through an Adventure, they earn badges — one piece per Episode, with the final piece awarded at Teachtime. Each partial badge is a visible signal of an incomplete journey: Tomo doesn't have the full picture yet.

Badges are shared with Tomo, who keeps track of them. This makes the accumulation feel directed — the child is not just collecting rewards, they are bringing something to Tomo. The badge mechanic reinforces Tomo's presence throughout the Episode journey even when he is not an active conversational participant.
...
The child discusses the Episode with the Adventure's topic-native expert characters. The conversation follows a four-phase deliberate practice arc:
...
### Teachtime
The culmination of an Adventure: the child teaches Tomo everything they have learned across all the Episodes. Tomo asks questions from genuine ignorance — he does not scaffold or hint using content from the Episodes. Only what the child has said aloud in the current session counts as "known" to Tomo.
...
| Term | Meaning |
|------|---------|
| Adventure | A thematic topic journey (like a series); contains 4–5 Episodes followed by a Teachtime |
| Episode | One part of an Adventure; includes an audio segment and an expert voice session |
...
| Topic-native expert | An Adventure-specific character drawn from the topic world (e.g. a Roman senator, a T-Rex) who hosts Episode voice sessions |
| Expert | A topic-native character who features in an Episode's audio and leads the post-Episode voice session |
| Teachtime | The culminating session at the end of an Adventure, where the child teaches Tomo |
| Badge | A reward earned per Episode (one piece each) and completed at Teachtime; kept by Tomo |
