  ...
  return (
    <div className="min-h-full w-full bg-[#f4ecdf] pb-6 pt-0 text-[#020617]">
      <div className="flex min-h-full w-full flex-col gap-3 px-3 pt-3 md:gap-4 md:px-4 md:pt-4 lg:px-6">
        <section className="w-full rounded-[14px] bg-[#020617] px-4 py-4 text-white shadow-[0_16px_34px_rgba(2,6,23,0.22)] md:rounded-[16px] md:px-6 md:py-5">
          ...
          <div className="relative mt-3 overflow-hidden rounded-[12px] bg-[linear-gradient(180deg,#111935_0%,#0a1024_100%)] px-3 py-3 md:rounded-[14px] md:px-4 md:py-4">
            <img
              src={tomoCelebrating}
        ...
        <div className="grid gap-3 md:grid-cols-2 md:gap-4">
          ...
          <ul className="mt-2 space-y-2.5">
            {strengths.map((item) => (
              ...
              >
                <span className="mt-0.5 text-[1.05rem] text-[#6b7280]">✦</span>
                <span>{item}</span>
              </li>
            ))}
          </ul>
